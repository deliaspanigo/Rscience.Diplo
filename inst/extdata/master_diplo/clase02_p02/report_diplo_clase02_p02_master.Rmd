---
title: "Diplo - Semana 02 - Parte 02 - Gráficos para 1 variable cuantitativa"
...
## Clase 02 - Parte 02 - Gráficos para 1 variable cuantitativa
...
```{r, include =T, eval = T, class.source="bg-success"}
# Gráfico de Histograma (Sin opciones)
hist(VR)
```
<br>
<br>
